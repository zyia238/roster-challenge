...
export default function BasicPopover({ popoverClicked, isEmpolyee , popoverClicked2 }: any) {
        ...
        {isEmpolyee ? (
          <div className={classes.selector}>
            <div>
              ...
              >
                <div onClick={handleSelectShift}>Select Shift</div>
                {isClicked && (
          ...
          <div className={classes.selector}>
            <div>
              ...
              >
                <div onClick={handleSelectShift}>Select Empolyee</div>
                {isClicked && (
                  <div className={classes.searchPart}>
                    <div className="search">searchBar</div>
                    <div>
                      {employeesList.map((e, i) => {
                        return (
                          <div
                            key={i}
                            onClick={() => {
                              handleEmployeeAdded({name:e.name} as any)
                            }}
                          >
                            {e.name}
                          </div>
